...
function suffixFecha(params = {}) {
  return params.fecha || `${params.desde}_a_${params.hasta}`;
}
...
export const exportacionesApi = {
  ...
  metricasJornada(params) {
    return downloadExport(
      '/productividad/exportar/metricas-jornada',
      params,
      `metricas_jornada_${params.fecha}`
    );
  },
  ...
  sesiones(params) {
    return downloadExport(
      ...
      params,
      `sesiones_productividad_${suffixFecha(params)}`
    );
  },

  reporteGrupal(params) {
    return downloadExport(
      '/productividad/exportar/reporte-grupal',
      params,
      `reporte_grupal_${suffixFecha(params)}`
    );
  },

  checadores(params) {
    return downloadExport(
      '/productividad/exportar/checadores',
      params,
      `checadores_${suffixFecha(params)}`
    );
  }
};
